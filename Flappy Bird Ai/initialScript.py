...
BIRD_IMGS = [pygame.transform.scale2x(pygame.image.load(os.path.join('bird1.png'))), pygame.transform.scale2x(pygame.image.load(os.path.join('bird2.png'))), pygame.transform.scale2x(pygame.image.load(os.path.join('bird3.png')))] #I'm gonna change the imame size x2
...
class Bird:
    ...
    def draw(self, win):
        ...
        rorated_image = pygame.transform.rotate(self.img, self.tilt)
