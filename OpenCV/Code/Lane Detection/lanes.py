...
img = cv2.imread("/home/nitolapio/Escritorio/Programación/Machine Learning/OpenCV/Resources/test_image.jpg")
...
averagedLines = averageSlopeIntercept(laneImage, lines)   # this is for optimizing line detection
lineImageOptimized = display_lines(laneImage, averagedLines)  
lineImage = display_lines(laneImage, lines)  
comboImage = cv2.addWeighted(laneImage, 0.8, lineImage, 1, 1)  # Con esto unimos las líneas a la imagen
comboImageOptimized = cv2.addWeighted(laneImage, 0.8, lineImageOptimized, 1, 1)
